	...
	zyMedia.MediaPlayer.prototype = {
		...
		setPlayerSize: function(width, height) {
			...
			if (height == undefined || height == 'auto') {
				var topback = document.querySelector('.height-full')
				...
				if(nativeHeight > nativeWidth) {
					t.height = Math.min(window.screen.height, t.width * (nativeHeight/nativeWidth))
					topback.style.display = 'inline-block'
				} else {
					if(t.height < t.width && video.style.opacity == 1) {
		...
		buildContainer: function() {
			...
			var back = '<svg t="1566897969136" class="height-full" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1108" width="20" height="20"><path d="M638.2 272.5H400.5V155c0-12.1-12.9-19.9-23.6-14.3l-304 158.9c-11.7 6.1-11.5 22.8 0.3 28.7l304 151.9c10.7 5.4 23.3-2.4 23.3-14.4V347.7h237.8c135.4 0 245.5 103.6 245.5 231s-110.1 231-245.5 231h-489c-20.8 0-37.6 16.8-37.6 37.6s16.8 37.6 37.6 37.6h489c176.8 0 320.6-137.3 320.6-306.2 0-168.8-143.9-306.2-320.7-306.2z" p-id="1109" fill="#ffffff"></path></svg>'
			...
			t.container.innerHTML = '<div class="zy_wrap"></div><div class="zy_controls"></div>' +
				(t.options.mediaTitle ? '<div class="zy_title">' + back + t.options.mediaTitle + '</div>' : '');
