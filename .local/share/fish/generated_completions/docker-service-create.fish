...
complete -c docker-service-create -l health-start-period --description '    Start period for the container to initialize before counting retries towa…'
...
complete -c docker-service-create -l init --description '    Use an init inside each service container to forward signals and reap pro…'
...
complete -c docker-service-create -l rollback-monitor --description '    Duration after each task rollback to monitor for failure (ns|us|ms|s|m|h)…'
complete -c docker-service-create -l rollback-order --description '    Rollback order ("start-first"|"stop-first") (default "stop-first").'
complete -c docker-service-create -l rollback-parallelism --description '    Maximum number of tasks rolled back simultaneously (0 to roll back all at…'
complete -c docker-service-create -l secret --description '    Specify secrets to expose to the service.'
complete -c docker-service-create -l stop-grace-period --description '    Time to wait before force killing a container (ns|us|ms|s|m|h) (default 1…'
...
complete -c docker-service-create -l update-monitor --description '    Duration after each task update to monitor for failure (ns|us|ms|s|m|h) (…'
