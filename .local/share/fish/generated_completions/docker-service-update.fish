...
complete -c docker-service-update -l health-start-period --description '    Start period for the container to initialize before counting retries towa…'
...
complete -c docker-service-update -l init --description '    Use an init inside each service container to forward signals and reap pro…'
...
complete -c docker-service-update -l rollback-parallelism --description '    Maximum number of tasks rolled back simultaneously (0 to roll back all at…'
